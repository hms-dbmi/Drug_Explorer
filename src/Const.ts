...
const CASES = [
  {
    ...
    description: `NSIAD is a rare genetic disorder of water and sodium imbalance that has prevalence of less than one in a million [Orphanet]. 
      ...
      While AVPR2 is involved in water retention and concentrating urine, NPR1 promotes vasodilation, decreased blood pressure, 
      and increased excretion of  water. Enhancing NPR1 activity could theoretically help counterbalance the excessive water reabsorption caused by the abnormally functioning AVPR2 receptors in NSIAD. 
      The NPR1 gene is target for Amyl Nitrite, hence this drug could be a useful therapy in NSIAD patients [Drugbank]. `,
    paths: [
      [
  ...
  },
  {
    ...
    drug: 'DB00425',
    open_list: [2],
    description: `Kleefstra syndrome is a rare genetic, intellectual disability syndrome caused by mutations in EHMT1 
    characterized by little speech development, autism spectrum disorder, and childhood hypotonia with a prevalence of less than one in a million [Orphanet]. 
    Zolpidem, commonly known as a sedative-hypnotic medication used for the short-term treatment of insomnia, 
    has been found in some cases to have unexpected neurological benefits in various neurodevelopmental and neurodegenerative disorders. 
    In neurodevelopmental disorders (such as Kleefstra syndrome), 
    the brain might have dormant or underactive neurons due to genetic or molecular abnormalities. 
    Zolpidem has been observed in some cases to temporarily “awaken” these underactive neural pathways [study]. 
    This effect is thought to be due to zolpidem’s action on GABA-A receptors (gene GABRG2) in the brain [Drugbank]. 
    GABA-A receptors are inhibitory, meaning they reduce neuronal activity. Zolpidem typically enhances the inhibitory effects of GABA, 
    leading to sedation. However, in certain neurological conditions, it may paradoxically improve neuronal activity in some brain regions [Case report]. 
    There have been anecdotal reports and a few small studies suggesting that zolpidem may improve symptoms like speech, motor abilities, 
    and alertness in some patients with severe brain injuries or neurodevelopmental disorders [another study].`,
    paths: [
      [
